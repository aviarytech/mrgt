...
program
  ...
  .option(
    "-v, --vsntag <vsntag>",
    "Version tag for which the MRG will be generated. When omitted, an MRG will be generated for every version of the terminology that is specified in the versions section of the SAF"
  )
  .option(
    "-e, --onNotExist <action>",
    "Specifies the action to take if a vsntag was specified but wasn't found in the SAF. Default is 'throw'. Options: 'throw', 'warn', 'log', 'ignore'"
  )
  .parse(process.argv);
